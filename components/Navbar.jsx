...
<nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600 ">
  ...
  <Image className="w-12 h-8" src={skia} alt='Op' />
      <span className="self-center text-2xl text-yellow-950 font-bold whitespace-nowrap ">Skiá Admin</span>
  </a>
  <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button onClick={()=>window.location.replace("/logout")} type="button" className="text-black bg-orange-300 hover:bg-orange-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center ">Logout</button>
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      <li>
        <a href="/" className="block py-2 px-3 text-gray-900  rounded hover:bg-orange-300 ">Database Home</a>
      </li>
      <li>
        <a href="/block/home" className="block py-2 px-3 text-gray-900 rounded hover:bg-orange-300 ">Blockchain Home</a>
      </li>
      {/* <li>
