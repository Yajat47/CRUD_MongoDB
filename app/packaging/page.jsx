...
const Packaging = () => {
    ...
    return (  
        <div>
          <Navbar/>
        <div class='flex mb-2 mt-24 text-2xl font-bold text-yellow-900'><svg onClick={()=> window.location.replace("/")} class="mr-6 w-6 h-8 text-gray-500 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 5H1m0 0 4 4M1 5l4-4"></path>
        ...
        <div class="grid gap-6 mb-6 grid-cols-1">
            ...
            <div className="mt-8">
            <label class='block mb-2 text-sm font-medium text-gray-900 ' for="brewing">Brewing Techniques
            </label>
            <input class='block w-full p-4 text-gray-900 border text-sm border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500' type="text" name="brewing" id="brewing" onChange={handleChange} >
            </input>
            </div>
            ...
            <div class="flex items-center justify-center w-56 h-56 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                ...
                { !isl &&
                <button className='text-white bg-yellow-900 hover:bg-yellow-800 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2' onClick={(e)=>checkIfWalletIsConnected(e)} >Submit Packaging </button>
              }            </div></div>
        </form>
        </div>
    );
